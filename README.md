...
Microbial communities are the <a href="https://www.nrel.colostate.edu/assets/nrel_files/projects/ssi/docs/microbiology_articles/falkowski_et_al_2008.pdf">engines that drive the biosphere</a>, playing critical biochemical functions in ecosystems and hosts, from soils to oceans to the human gut. The goal of the Gowda Lab is to discover “natural design principles” underlying the functions carried out by microbial communities. Our view is that, by understanding how microbial physiology, ecology, and evolution conspire to “build” community metabolism, we will learn how to rationally manipulate and design complex microbiomes for the benefit of human health. We are an interdisciplinary team of researchers at the Ohio State University who use experiments, computation, and theory in the pursuit of this goal.
