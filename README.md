...
3. **Single-cell 'omics of fine scale diversity:** The fundamental unit of a microbial community is not the population but the single cell—even at the strain-level, there is staggering diversity arising at the genomic and transcriptomic scales, which is essentially papered-over by bulk sequencing measurements. The long term goal of this project is to apply emerging bacterial single cell genomics and transcriptomics approaches (in collaboration with the [Sullivan](https://u.osu.edu/viruslab/) and [Prakash](https://mae.osu.edu/people/prakash.31) labs) to the study of communities, and to develop computational approaches relevant to the unique questions and challenges posed by these measurements in a community context.
