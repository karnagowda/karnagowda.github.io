...
<div class="photo-container">
  ...
  <div class="description">
    <a href="https://doi.org/10.1038/s41564-024-01752-4">Environmentally dependent interactions shape patterns in gene content across natural microbiomes, <em>Nature Microbiology</em> (2024).</a> An old truism in microbial ecology is "everything is everywhere but the environment selects". But how exactly does the environment select? And we know that interactions between organisms in microbial communities are widespread - surely these must matter as well. In this paper, we show that community assembly is shaped by microbial physiology and interactions, not just environmental factors. Using a statistical approach to analyze global topsoil microbiome data, we uncovered a novel link between denitrification reductase gene abundances and soil pH. Lab experiments and isolate characterizations confirmed that low pH stress promotes toxin-antitoxin codependency between strains.
  </div>
</div>
