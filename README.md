...
We focus experimentally on **pseudomonads**, which are genetically tractable and exhibit enormous natural diversity in [which denitrification steps they can do](https://www.gowdalab.org/assets/docs/pseudomonas_denit_gtdb214_annotree.html) (in addition to being relevant to human health and industry). We take a **systems biology** perspective to connect intracellular tradeoffs to growth, metabolic flux, and the ecology of denitrifying communities.
